...
const RESTORE_STATE = "todolist-application/App/RESTORE-STATE";
...
export const addTask = (todoListId, taskId, taskTitle) => ({type: ADD_TASK, todoListId, taskId, taskTitle})
export const removeTask = (todoListId, taskId) => ({type: REMOVE_TASK, todoListId, taskId})
...
export const restoreState = (state) => ({type: RESTORE_STATE, state})
//thunk
